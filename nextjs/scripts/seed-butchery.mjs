...
const products = [
  ...
  {
    sku: "Z22009", slug: "magnetic-knife-holder-30cm",
  ...
  {
    sku: "Z22012", slug: "magnetic-knife-board-60cm",
    ...
    regular_price: 424, stock_status: "on_order", stock_quantity: 0,
  ...
  // ── HANGING SYSTEMS ──────────────────────────────────────────────────────────
  {
    sku: "Z44043", slug: "s-hooks-160x6mm-60kg",
    ...
    regular_price: 45, stock_status: "in_stock", stock_quantity: 58,
  ...
  {
    sku: "Z44044", slug: "s-hooks-160x8mm-100kg",
  ...
  {
    sku: "Z44046", slug: "s-hooks-200x9mm-125kg",
  ...
  {
    sku: "Z44053", slug: "s-hooks-300x12mm-200kg",
    ...
    regular_price: 140, stock_status: "in_stock", stock_quantity: 190,
  ...
  },
  {
    ...
    regular_price: 205, stock_status: "on_order", stock_quantity: 0,
  ...
  {
    sku: "Z44052", slug: "swivel-hooks-300x12mm-200kg",
    name: "Professional Turning Hook — 300×12mm 200kg",
  ...
  {
    sku: "WK104", slug: "xl-swivel-hooks-500x12mm-250kg",
    ...
    regular_price: 466, stock_status: "in_stock", stock_quantity: 17,
  ...
  },
  {
    ...
    regular_price: 900, stock_status: "on_order", stock_quantity: 0,
  ...
  {
    sku: "Z44060a", slug: "gambrel-adjustable-810mm",
    ...
    regular_price: 1800, stock_status: "in_stock", stock_quantity: 2,
  ...
  // ── SCALES ───────────────────────────────────────────────────────────────────
  {
    sku: null, slug: "platform-scale-15kg",
  ...
  {
    sku: "Z55011", slug: "hanging-scale-100kg",
  ...
  {
    sku: "Z55012", slug: "hanging-scale-200kg",
    ...
    regular_price: 1500, stock_status: "on_order", stock_quantity: 0,
  ...
  {
    sku: "Z55015", slug: "digital-hanging-scale-300kg",
    ...
    regular_price: 5200, stock_status: "on_order", stock_quantity: 0,
  ...
  // ── PROTECTIVE CLOTHING ──────────────────────────────────────────────────────
  {
    ...
    regular_price: 399, stock_status: "in_stock", stock_quantity: 6,
  ...
  {
    sku: "Z33013", slug: "cut-resistant-gloves-small",
    ...
    regular_price: 399, stock_status: "in_stock", stock_quantity: 3,
  ...
  {
    sku: "Z33015", slug: "cut-resistant-gloves-medium",
  ...
  {
    sku: "Z33020", slug: "cut-resistant-gloves-large",
  ...
  // ── SALMON DISPLAY BOARDS ───────────────────────────────────────────────────
  {
    sku: "VL0295", slug: "salmon-board-12x26-5cm-pack-5",
    name: "Gold/Black Salmon Board 12 × 26.5 cm (Pack of 5)",
    short_description: "Elegant black and gold presentation boards for smoked salmon, charcuterie and deli display. Pack of 5.",
    description: `<p>Professional <strong>gold and black salmon display boards</strong> — the classic presentation surface for smoked salmon, trout, charcuterie and deli portions.</p><ul><li><strong>Size:</strong> 12 × 26.5 cm</li><li><strong>Pack:</strong> 5 boards</li><li>Black base with gold trim</li><li>Ideal for retail display and catering</li></ul>`,
    regular_price: 150, stock_status: "in_stock", stock_quantity: 10,
    is_featured: false, sort_order: 30, tags: ["cutting-board", "display-board", "salmon-board"],
    primary_image: `${B}/gold-black-salmon-board-12x26-5cm-pack-5-vl0295.webp`,
    images: [{ url: `${B}/gold-black-salmon-board-12x26-5cm-pack-5-vl0295.webp`, alt: "Gold/Black Salmon Board 12x26.5cm Pack of 5", is_primary: true }],
  },
  {
    sku: "VL0296", slug: "salmon-board-18x53cm-pack-5",
    name: "Gold/Black Salmon Board 18.5 × 53 cm (Pack of 5)",
    short_description: "Medium gold and black presentation boards for smoked salmon and deli display. Pack of 5.",
    description: `<p>Medium-sized <strong>gold and black salmon display boards</strong> for whole fillets, sliced salmon and charcuterie platters.</p><ul><li><strong>Size:</strong> 18.5 × 53 cm</li><li><strong>Pack:</strong> 5 boards</li><li>Black base with gold trim</li></ul>`,
    regular_price: 200, stock_status: "in_stock", stock_quantity: 10,
    is_featured: false, sort_order: 31, tags: ["cutting-board", "display-board", "salmon-board"],
    primary_image: `${B}/gold-black-salmon-board-18x53cm-pack-5-vl0296.webp`,
    images: [{ url: `${B}/gold-black-salmon-board-18x53cm-pack-5-vl0296.webp`, alt: "Gold/Black Salmon Board 18.5x53cm Pack of 5", is_primary: true }],
  },
  {
    sku: "VL0297", slug: "salmon-board-21x57cm-pack-5",
    name: "Gold/Black Salmon Board 21 × 57 cm (Pack of 5)",
    short_description: "Large gold and black presentation boards for full salmon sides and deli display. Pack of 5.",
    description: `<p>Large <strong>gold and black salmon display boards</strong> — suited to full sides, large fillets and premium deli presentation.</p><ul><li><strong>Size:</strong> 21 × 57 cm</li><li><strong>Pack:</strong> 5 boards</li><li>Black base with gold trim</li></ul>`,
    regular_price: 230, stock_status: "in_stock", stock_quantity: 10,
    is_featured: false, sort_order: 32, tags: ["cutting-board", "display-board", "salmon-board"],
    primary_image: `${B}/gold-black-salmon-board-21x57cm-pack-5-vl0297.webp`,
    images: [{ url: `${B}/gold-black-salmon-board-21x57cm-pack-5-vl0297.webp`, alt: "Gold/Black Salmon Board 21x57cm Pack of 5", is_primary: true }],
  },
  ...
  // ── KNIFE SETS ───────────────────────────────────────────────────────────────
  {
    ...
    is_featured: false, sort_order: 40, tags: ["knife", "knife-set", "butchery"],
  ...
  },
  {
    ...
    is_featured: true, sort_order: 41, tags: ["knife", "knife-set", "butchery"],
  ...
  },
  {
    ...
    is_featured: false, sort_order: 42, tags: ["knife", "knife-set", "kitchen"],
    primary_image: null,
    images: [],
  },
  {
    sku: "Z33014", slug: "cut-resistant-gloves-xs",
    name: "Professional Cut-Resistant Gloves — XS (Level 5)",
    short_description: "Level 5 cut-resistant gloves in extra-small.",
    description: `<p><strong>Level 5 cut-resistant gloves</strong> in extra-small.</p>`,
    regular_price: 399, stock_status: "in_stock", stock_quantity: 3,
    is_featured: false, sort_order: 28, tags: ["protective", "gloves", "cut-resistant", "xs"],
    primary_image: `${B}/professional-cut-resistant-gloves-xs-level-5-protection.webp`,
    images: [{ url: `${B}/professional-cut-resistant-gloves-xs-level-5-protection.webp`, alt: "Cut-Resistant Gloves XS", is_primary: true }],
  },
  {
    sku: "Z66130", slug: "pro-star-meat-mincer-90kg",
    name: "Pro-Star Meat Mincer (90 kg/h)",
    short_description: "Pro-Star electric meat mincer — 90 kg/h throughput for sausage and butchery use.",
    description: `<p>The <strong>Pro-Star meat mincer</strong> processes up to 90 kg per hour.</p>`,
    regular_price: 4650, stock_status: "on_order", stock_quantity: 0,
    is_featured: true, sort_order: 35, tags: ["machinery", "mincer", "butchery"],
    primary_image: `${B}/pro-star-meat-mincer-90kg-z66130.webp`,
    images: [{ url: `${B}/pro-star-meat-mincer-90kg-z66130.webp`, alt: "Pro-Star Meat Mincer", is_primary: true }],
  },
  {
    sku: "Z99051", slug: "cutting-board-400x250x20",
    name: "Professional Cutting Board 400 × 250 × 20 mm",
    short_description: "Cut-resistant polyethylene cutting board 400 × 250 × 20 mm.",
    description: `<p>Professional <strong>polyethylene cutting board</strong>.</p>`,
    regular_price: 503, stock_status: "in_stock", stock_quantity: 5,
    is_featured: false, sort_order: 50, tags: ["cutting-board", "poly-board"],
    primary_image: `${B}/cutting-board-400x250x20-z99051.webp`,
    images: [{ url: `${B}/cutting-board-400x250x20-z99051.webp`, alt: "Cutting Board 400x250", is_primary: true }],
  },
  {
    sku: "Z99053", slug: "cutting-board-500x300x20",
    name: "Professional Cutting Board 500 × 300 × 20 mm",
    short_description: "Polyethylene cutting board 500 × 300 × 20 mm.",
    description: `<p>Medium <strong>polyethylene cutting board</strong>.</p>`,
    regular_price: 705, stock_status: "in_stock", stock_quantity: 5,
    is_featured: false, sort_order: 51, tags: ["cutting-board", "poly-board"],
    primary_image: `${B}/cutting-board-500x300x20-z99053.webp`,
    images: [{ url: `${B}/cutting-board-500x300x20-z99053.webp`, alt: "Cutting Board 500x300", is_primary: true }],
  },
  {
    sku: "Z99055", slug: "cutting-board-500x400x20",
    name: "Professional Cutting Board 500 × 400 × 20 mm",
    short_description: "Large polyethylene cutting board 500 × 400 × 20 mm.",
    description: `<p>Large <strong>polyethylene cutting board</strong>.</p>`,
    regular_price: 918, stock_status: "in_stock", stock_quantity: 3,
    is_featured: false, sort_order: 52, tags: ["cutting-board", "poly-board"],
    primary_image: `${B}/cutting-board-500x400x20-z99055.webp`,
    images: [{ url: `${B}/cutting-board-500x400x20-z99055.webp`, alt: "Cutting Board 500x400", is_primary: true }],
  },
  {
    sku: "Z99057", slug: "cutting-board-600x400x20",
    name: "Professional Cutting Board 600 × 400 × 20 mm",
    short_description: "Extra-large polyethylene cutting board 600 × 400 × 20 mm.",
    description: `<p>Extra-large <strong>polyethylene cutting board</strong>.</p>`,
    regular_price: 1059, stock_status: "on_order", stock_quantity: 0,
    is_featured: false, sort_order: 53, tags: ["cutting-board", "poly-board"],
    primary_image: `${B}/cutting-board-600x400x20-z99057.webp`,
    images: [{ url: `${B}/cutting-board-600x400x20-z99057.webp`, alt: "Cutting Board 600x400", is_primary: true }],
  },

  // ── CUTTING BOARDS ───────────────────────────────────────────────────────────
  {
    sku: "Z11040", slug: "cutting-board-scraper-stainless",
    ...
    regular_price: 363, stock_status: "in_stock", stock_quantity: 3,
...
async function seed() {
  ...
  for (const item of products) {
    ...
    const { data: product, error } = await supabase
      .from("products")
      .upsert({ ...productData, category_id: cat.id, primary_image_url: primary_image ?? null }, { onConflict: "slug" })
      .select().single();
