...
import { MAIN_PHONE } from "@/lib/contact";
        ...
        <div className="section-container max-w-2xl text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 text-sm font-bold text-primary">
            <div className="flex items-center gap-2">
              ...
              <PhoneNumbers layout="stacked" linkClassName="hover:text-secondary transition-colors" />
            </div>
            ...
            <a href={`https://wa.me/${MAIN_PHONE.whatsapp}`} target="_blank" rel="noopener noreferrer"
