  ...
  return (
    <main className="py-16">
      <div className="section-container max-w-3xl">
        ...
        <Placeholder label="app-kitchen-meal-prep" />
        ...
        <div className="prose-lava mt-12">
          ...
          <Placeholder label="app-kitchen-bulk-buying" aspect="aspect-[16/6]" />
          ...
          <Placeholder label="app-kitchen-pantry-organisation" aspect="aspect-[16/6]" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {[
              ...
              <Link key={href + name} href={href} className="border border-border bg-surface p-4 hover:border-primary transition-colors group">
